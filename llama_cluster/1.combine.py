...
def merge_json_parts():
    ...
    files = sorted(glob.glob("/home/yl9210a-hpc/chem_project/llama_cluster/output/llama_part_*.json"))
    ...
    output_name = "/home/yl9210a-hpc/chem_project/llama_cluster/output/final_bace_descriptions.json"
...
if __name__ == "__main__":
    ...
    # 2. 合併完後才跑 Embedding
    embedding_script = "/home/yl9210a-hpc/chem_project/llama_cluster/2.embedding.py"
